...
module.exports = class NodeProject extends BaseProject {
	...
	async test() {
		...
		if (await this.manifest.hasProperty('devDependencies.typescript')) {
			...
			await this.typescriptConfig.assertPropertyMatches('compilerOptions.declarationMap', true);
			...
			await this.typescriptConfig.assertPropertyMatches('compilerOptions.removeComments', true);
